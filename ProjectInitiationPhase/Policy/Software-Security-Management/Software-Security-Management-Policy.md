...
| ----- | ----------- | ----------------- | ------ | ------------------- | ------ |
| SC-01 | 軟體白名單管理     | 所有工具須經核准          | A.8.19 | 軟體清冊、核准紀錄           | 資訊處 / 研發單位   |
| SC-02 | 套件來源驗證      | 僅允許官方來源           | A.8.7  | SCA 掃描報告            | 研發單位   |
| SC-03 | 套件版本鎖定      | 使用 lock file      | A.8.25 | 原始碼版本庫              | 研發單位   |
| SC-04 | 安裝安全控制      | 禁止執行 scripts      | A.8.28 | 設定截圖或設定檔            | 研發單位   |
| SC-05 | 憑證保護        | 禁止本機存放            | A.8.12 | Secret 掃描報告         | 資訊處    |
| SC-06 | 環境隔離        | 使用 VM / Container | A.8.31 | 環境設定文件              | 研發單位   |
| SC-07 | 軟體成分分析（SCA） | 使用安全掃描工具          | A.8.29 | Snyk / BlackDuck 報告 | 研發單位     |
| SC-08 | CI/CD 安全控制  | 實施 security gate  | A.8.16 | Pipeline 紀錄         | 研發單位 |
| SC-09 | 事件應變        | 執行通報流程            | A.5.26 | 事件通報紀錄              | 資訊處    |
| SC-10 | 發布安全        | 發布前完成掃描           | A.8.8  | Release 安全報告        | 研發單位   |
